  ...
  <head>
    ...
    <style amp-custom>
      ...
      @font-face {
        ...
        src: local('☺'), url('/assets/fonts/ptsans-narrow-bold/PTSans-Narrow-Bold.woff') format('woff'), url('/assets/fonts/ptsans-narrow-bold/PTSans-Narrow-Bold.ttf') format('truetype'), url('/assets/fonts/ptsans-narrow-bold/PTSans-Narrow-Bold.svg') format('svg');
        font-weight: normal;
        font-style: normal;
      }
      h1,h2,h3,h4,h5,h6{
